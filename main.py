...
common_voice_data = os.path.join(
    current_dir,
    "Sources and References/Data Sets/cv-corpus-17.0-2024-03-15/en/validated.tsv",
)
deepfake_data = os.path.join(
    current_dir, "Sources and References/Data Sets/release_in_the_wild/meta.csv"
)
deepfake_data_dir = os.path.join(
    current_dir, "Sources and References/Data Sets/release_in_the_wild"
)
common_voice_data_dir = os.path.join(
    current_dir, "Sources and References/Data Sets/cv-corpus-17.0-2024-03-15/en/clips"
)
...
deepfake_audio_files, speaker_name = audio_data.get_in_the_wild_audio_file_data(
    deepfake_data, condense_size=1000, input_select=0
)
output_location = (
    "voice_recognition/" + speaker_name + "_deepfake_voice_export_filtered.csv"
)
export_csv = os.path.join(current_dir, output_location)
audio_data.load_and_export_in_the_wild_data(
    data=deepfake_audio_files,
    audio_file_directory=deepfake_data_dir,
    output_location=export_csv,
)
